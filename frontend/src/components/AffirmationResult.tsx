...
export default function AffirmationResult({ affirmation, name }: Props) {
  ...
  return (
    <div className="affirmation-card mt-6 space-y-6">
      ...
      <div className="text-center space-y-2">
        <h3 className="text-2xl sm:text-3xl font-serif font-semibold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
      ...
      <div className="relative">
        ...
        <div className="relative glass-card p-6 sm:p-8 rounded-2xl">
          <p className="text-base sm:text-lg leading-relaxed text-center font-medium whitespace-pre-wrap">
            {displayed}
